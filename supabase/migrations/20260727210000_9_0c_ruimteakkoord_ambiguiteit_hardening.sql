  ...
  loop
    ...
    do update set
      ...
      opmerkingen =
        'Gezamenlijk akkoord via ruimtecontrole.'
    returning
      controle_resultaten.id,
      controle_resultaten.woning_controlepunt_id
    into
...
is
  'Inspection Engine 9.0C: slaat geselecteerde normale controlepunten van één ruimte gezamenlijk en transactioneel als goed op; SQL-kolommen hebben expliciet voorrang boven gelijknamige retourvariabelen.';
