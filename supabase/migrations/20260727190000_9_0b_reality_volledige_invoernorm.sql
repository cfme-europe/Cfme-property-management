...
-- =========================================================
-- 9.0B REALITY ENGINE — VOLLEDIGE INVOERNORM
-- =========================================================

revoke all on table public.kamers from anon;
...
drop policy if exists "Kamers bevoegd toevoegen" on public.kamers;
drop policy if exists "Kamers bevoegd wijzigen" on public.kamers;
...
declare
  ...
  v_behouden_verdiepingen bigint[] := '{}';
  v_behouden_ruimten bigint[] := '{}';
  v_behouden_objecten bigint[] := '{}';
  v_behouden_controlepunten bigint[] := '{}';
